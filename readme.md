...
| ------------ | ------------------ | ------------------ | --------------------- | ------------------ |
| PER          | 0.9765258215962441 | 在跑-服务器12      | 0.565833893421164     | 0.867764538559205  |
...
| 我们的方法   | 0.9953488372093023 |                    | 0.8406350406057971(?) |                    |
| kaleiscope   | 0.9095477386934674 | 在跑-服务器10      | 在跑-1号              |                    |
| ices         | 0.9711538461538461 | done               | 0.6071428571428571    | 0.9858             |
| qmix（可选） |                    |                    |                       |                    |
...
| 算法         | 2s3z     | MMM2          | 10m_vs_11m           | 8m                 |
| ------------ | -------- | ------------- | -------------------- | ------------------ |
| PER          | 在跑-3号 | 在跑-服务器12 | 0.20669463632415203  | 0.8486486486486486 |
| SUPER        |          | 在跑-2号      | 0.602470292252863    | 0.740261437908496  |
| DIFFER       |          |               | 0.09571788413098237  | 0.8263157894736843 |
| 我们的方法   |          |               | 0.640350877192982(?) |                    |
| kaleiscope   |          |               |                      |                    |
| ices         |          |               |                      |                    |
| qmix（可选） |          |               |                      |                    |
