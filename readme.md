...
我们的方法：python src/main.py --config=inspire_qmix --env-config=sc2 with env_args.map_name=2s3z t_max=2005000
...
| ------------ | ------------------ | ------------------ | ------------------ | ------------------ |
| PER          | 0.9765258215962441 | 在跑-3号           | 0.565833893421164  | 0.867764538559205  |
| SUPER        | 0.9855769230769231 | 在跑-3号           | 0.678294553976223  | 0.924538795684027  |
| DIFFER       | 0.9765             | 0.6341463414634146 | 0.7344632768361582 | 0.9329896907216495 |
| 我们的方法   | 0.9953488372093023 | 在跑-服务器12      | 在跑-服务器12      | 在跑-1号           |
| kaleiscope   | 0.9095477386934674 | 在跑-服务器10      | 在跑-1号           | 在跑-服务器12      |
| ices         | 0.9711538461538461 | 在跑-2号           | 0.6071428571428571 | 在跑-1号           |
| qmix（可选） |                    |                    |                    |                    |
...
| 算法         | 2s3z     | MMM2 | 10m_vs_11m          | 8m                 |
| ------------ | -------- | ---- | ------------------- | ------------------ |
| PER          | 在跑-3号 |      | 0.20669463632415203 | 0.8486486486486486 |
| SUPER        |          |      | 0.602470292252863   | 0.740261437908496  |
| DIFFER       |          |      | 0.09571788413098237 | 0.8263157894736843 |
| 我们的方法   |          |      |                     |                    |
| kaleiscope   |          |      |                     |                    |
| ices         |          |      |                     |                    |
| qmix（可选） |          |      |                     |                    |
